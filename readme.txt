...
Use Stripe Checkout to Accept Donations without a Page Refresh
...
https://www.youtube.com/watch?v=2E-NMOtjEhg
...
1. Stripe Checkout Popup
1. Basic View
1. Stripe settings, found in the admin under ‘Settings’ -> ‘Stripe Donation’
1. More settings for the checkout part

== Changelog ==

1.2.1 - Changed on click handler
