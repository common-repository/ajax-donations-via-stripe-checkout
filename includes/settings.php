...
{ 
	...
	echo "<p>";
	echo __("The following four fields will sync your donation buttons to your Stripe account.", 'hg-stripe_donate') . "</p>";
	echo "<p>";
...
{ 
	...
	echo "<p>";
	echo " <a href='https://halgatewood.com/docs/plugins/stripe-donations' class='button' target='_blank'>";
