...
function hg_stripe_donate_shortcode( $atts )
{
	...
	$no_amount_text			= isset($atts['no_amount_text']) ? $atts['no_amount_text'] : __('Please enter an amount you would like to donate', 'hg-stripe-donate');
...
?>
	...
	<script>
		...
		jQuery(document).ready(function() 
		{
			...
			jQuery('#hg-stripe-donate-button-<?php echo $button_id ?>').on('click', function( e ) 
			{
				...
				{
					jQuery("#<?php echo $error_html_id; ?>").html('<?php echo $no_amount_text; ?>').slideDown('fast');
				}
			});
		});
